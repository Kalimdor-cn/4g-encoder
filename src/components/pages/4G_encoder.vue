  ...
  <div class="container">
    <div class="query-div">
      <span class="fl">
        ...
        <el-button @click="openDialog()" type="success">添加编码器</el-button>
    ...
    >
      ...
      <el-table-column prop="status" label="状态" width="100" align="center">
        <template slot-scope="scope">
          <img class="status-img" src="../../assets/img/de_on.png" alt v-if="scope.row.status == 1">
          <img class="status-img" src="../../assets/img/de_off.png" alt v-else>
        </template>
      </el-table-column>
